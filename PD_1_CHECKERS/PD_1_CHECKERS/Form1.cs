...
namespace PD_1_CHECKERS
{
    public partial class Form1 : Form
    {
        const int mapSize = 4; // map size
        ...
        public Form1()
        {
            ...
            whiteFigure = new Bitmap(new Bitmap(@"C:\Users\artem\Desktop\CHECKERS\w.png"), new Size(cellSize - 10, cellSize - 10));
            blackFigure = new Bitmap(new Bitmap(@"C:\Users\artem\Desktop\CHECKERS\b.png"),new Size(cellSize - 10, cellSize - 10));
        ...
        public void CreateMap()
        {
            ...
            for (int i = 0; i < mapSize; i++)
            {
                for (int j = 0; j < mapSize; j++)
                {
                    ...
                    button.Location = new Point(j * cellSize, i * cellSize); // смена позиции относительно карты
        ...
        {
            if (((prevButton.Location.Y/cellSize % 2) != 0 && (prevButton.Location.X / cellSize % 2) == 0) 
                || ((prevButton.Location.Y / cellSize % 2) == 0 && (prevButton.Location.X / cellSize % 2) != 0))
            {
                return Color.Gray;
            }
            return Color.White;
